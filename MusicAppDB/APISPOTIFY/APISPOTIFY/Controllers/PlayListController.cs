...
namespace MusicAppDB.Controllers
{
    ...
    public class PlayListController : ControllerBase
    {
        ...
        public IActionResult AddPlaylist(Playlist song)
        {
        ...
        {
            var song = _playlistdata.GetPlaylist(PlaylistID);
            if (song != null)
            {
                _playlistdata.DeletePlaylist(song);
                return Ok();
            }
            return NotFound($"songs with id :{PlaylistID} was not found");
        ...
        public IActionResult EditPlayList(int id, Playlist Playlist)
        {
            ...
            {
                Playlist.Title = existingSong.Title;
