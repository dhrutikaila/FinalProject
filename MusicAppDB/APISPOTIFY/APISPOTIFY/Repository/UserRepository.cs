...
namespace APISPOTIFY.Repository
{
    public class UserRepository: GenericRepository<ApplicationUser>, IUser
    {
        ...
        {
            var users = _MusicAppDBContext.Users;
            return users;
        }
        public User FindContact(string contact)
        {
            var registeredUser = _MusicAppDBContext.Users.SingleOrDefault(x => x.Contactno == contact);
        ...
        {
            var registeredUser = _MusicAppDBContext.Users.FirstOrDefault(x => x.UserName == name);
            return registeredUser;
        }
        ...
        public async Task<IdentityResult> RegisterUser(RegisterModel model)
        {
            ...
            if (result.Succeeded)
            {
               ...
               // var otp = rnd.Next(1000, 9999);
                _MusicAppDBContext.Users.Add(new User()
                {
